...
| TV-Q4 | Tử Vi Đẩu Số Toàn Thư — Quyển 4: **Khang Tiết Bổ Chú + Phê Mệnh Templates** | 紫微斗数全书·卷四 | Trần Đoàn + **Thiệu Khang Tiết** (邵雍, co-author dominant Q4) | **6/6 Published** | **91 (A4)** | `data/published/tu-vi-q4-la-so-co-kim.pdf` (432 KB, Khang Tiết 30+ sections + 2 phê mệnh templates + 6 cases lịch sử dẫn chứng) | ✅ **v1.0 PUBLISHED 2026-05-19** · ⚠️ **Re-titled 2026-05-20** (thâm nhuần phát hiện Khang Tiết DOMINATES Q4 — không phải case database) |
| **TV-BỘ** | **Tử Vi Đẩu Số Toàn Thư — Bộ 4 Quyển ĐẦY ĐỦ (Q1+Q2+Q3+Q4 + Phụ lục)** | 紫微斗数全书 | **Trần Đoàn + Thiệu Khang Tiết** (joint — Khang Tiết bổ chú ~35 lần across Q2-Q4) + Phan Hy Doãn + Dương Nhất Vũ biên tập | **6/6 Published** | **395 (A4)** | `data/published/tu-vi-bo-toan-thu.pdf` (1.59 MB, 1193 cách + 686 concepts + bảng tra A-Z) | ✅ **BỘ v2.0 PUBLISHED 2026-05-19 đêm** · ⚠️ **Authorship corrected 2026-05-20** |
