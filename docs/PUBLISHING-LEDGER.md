...
| TS-CHEIRO | Sách Về Những Con Số (Cheiro) | Cheiro's Book of Numbers | Cheiro (Louis Hamon, 1866-1936) | **2-3/6** (core restored EN→VI) | — | `data/restored_books/cheiro-book-of-numbers/content.md` (bảng Chaldean + số đơn 1-9 + số kép 10-32; public domain Archive.org) | 🔶 **IN PROGRESS 2026-06-05** — Thần Số Học · chờ attach PDF gốc + Stage 6 |
