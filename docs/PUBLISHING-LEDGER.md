...
| TS-CHEIRO | Sách Về Những Con Số (Cheiro) | Cheiro's Book of Numbers | Cheiro (Louis Hamon, 1866-1936) | **6/6 draft** (core EN→VI) | **6 (A5)** | `data/published/cheiro-book-of-numbers-core-v0.1.pdf` (57 KB, reportlab+DejaVuSans — DRAFT, chưa qua WeasyPrint design) | 🔶 **DRAFT PUBLISHED 2026-06-05** — Thần Số Học · chờ ① attach PDF gốc (network allowlist chặn) ② re-render WeasyPrint design |
