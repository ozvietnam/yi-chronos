...
| **TV-STT** | **Tử Vi Tính Được — Hoàn Toàn Khoa Học, Phiên bản Siêu Trí Tuệ AI** | — (nguyên tác mới, kế thừa _Tử Vi Hoàn Toàn Khoa Học_) | Anh (founder) + AI · kế thừa TS. Đằng Sơn | **5-6/6 draft** (viết xong + render PDF) | **51 (A5)** | `data/published/Tu-Vi-Tinh-Duoc-v0.1.pdf` (712 KB, 7 phần + 2 phụ lục, pandoc→WeasyPrint) | 🔶 **DRAFT v0.1 2026-06-22** — phái `tu_vi_dang_son`; luận đề "tính được TÍNH ≠ tính được MỆNH"; chờ đủ 8 ảnh + đối chiếu corpus |
