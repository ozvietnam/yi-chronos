...
| **TV-STT** | **Tử Vi Tính Được — Hoàn Toàn Khoa Học, Phiên bản Siêu Trí Tuệ AI** | — (nguyên tác mới, kế thừa _Tử Vi Hoàn Toàn Khoa Học_) | Anh (founder) + AI · kế thừa TS. Đằng Sơn | **5-6/6 draft** (grounded bằng nguồn gốc) | **52 (A5)** | `data/published/Tu-Vi-Tinh-Duoc-v0.2.pdf` (778 KB, 7 phần + 2 phụ lục, pandoc→WeasyPrint) | 🔶 **DRAFT v0.2 2026-06-22** — phái `tu_vi_dang_son`; luận đề "tính được TÍNH ≠ tính được MỆNH"; **v0.2 grounded** bằng PDF gốc Đằng Sơn (giả tướng · địa-bàn-thiên-văn · ngũ-hành-xấp-xỉ); thâm nhuần 3 vòng (journal) |
