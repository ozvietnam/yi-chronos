...
- MỆNH-NGỘ (tr.163-166, cặp với Iron Rule #8): bộ ba TÍNH trời cho → MỆNH mình xử → NGỘ trời định. "Tích công lũy hành là phần QUÂN TỬ; được hay không quy thuộc TRỜI" · "Không Thái do mệnh, Khúc Thân tùy ngộ." Đoán quẻ đừng hứa kết quả — chỉ rõ phần người làm được (tích công) và phần thuộc ngộ. Quan hệ làm việc cùng khung: "quân-thần TRẠCH nhau hệ ở NHÂN, ĐẮC nhau hệ ở THIÊN" (tr.190) — chọn cho chính là việc mình, gặp được là việc trời.
