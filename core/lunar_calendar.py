...
# ─── CIVIL calendar = Vietnam (Hồ Ngọc Đức, UTC+7) ───────────────────────────────
# Deliberately VN, NOT sxtwl: this drives user-facing civil dates — incl. Tết and
# auspicious-day picking — where Vietnamese users expect the OFFICIAL Vietnamese
# calendar (e.g. Tết 2030 = 02/02 in VN vs 03/02 in CN). Birth-chart + divination
# (Tử Vi / Mai Hoa / Bát Tự / can-chi) intentionally use sxtwl (Chinese source
# tradition) via core.chronos / lich_conversion. See #15.
